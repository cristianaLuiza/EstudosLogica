    ...
    public static void main(String[] args) {
        ...
        renda_anual = leia.nextDouble();
            ...
            if(renda_anual<12000){
                imposto= imposto-(dependentes*300);
                System.out.print("\nInsento de taxa, você deve receber  "+ imposto);
            }
            else if(renda_anual>12000 && renda_anual<25000){
                imposto = renda_anual * (12/100);
                imposto = imposto - (dependentes * 300);
                System.out.print("\nVocê teve 12% de taxa cobrada, seu valor final é de "+imposto);
            }
            else {
                imposto = renda_anual * (12/100);
                imposto = imposto - (dependentes * 300);
                System.out.print("\nVocê teve 27,5% de taxa cobrada seu valor final é de "+imposto);
            }
